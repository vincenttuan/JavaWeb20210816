...
public class WatchListDao {
	...
	public int create(WatchList watchList) {
		String sql = "Insert into watchList(investid, stockpoolid) values(?, ?)";
		
		try(PreparedStatement pstmt = conn.prepareStatement(sql)) {
			pstmt.setInt(1, watchList.getInvestid());
			pstmt.setInt(2, watchList.getStockpoolid());
