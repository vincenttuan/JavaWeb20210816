		...
		<tr>
			<td valign="top" style="padding: 10px">
				<form class="pure-form">
					<fieldset>
						<legend><img src="/JavaWeb20210816/image/man.png" width="40">&nbsp;&nbsp;&nbsp;&nbsp;User form</legend>
			...
			<td valign="top" style="padding: 10px">
				<form class="pure-form" method="post" action="/JavaWeb20210816/lab/user/query">
					<fieldset>
						<legend><img src="/JavaWeb20210816/image/team.png" width="40">&nbsp;&nbsp;&nbsp;&nbsp;User list</legend>
						<button type="submit" class="pure-button pure-button-primary" style="float: right;margin-left: 5px">查詢</button>
						<input type="text" name="u_username" placeholder="請輸入名字關鍵字" 
						...
						<table class="pure-table pure-table-bordered">
							...
							<tbody>
								...
								<tr>
									<td>${ user.u_id }</td>
									<td>
										<img src="/JavaWeb20210816/image/${ user.u_priority==0?'man':'programmer' }.png" width="30">
									</td>
